...
\definecolor{sisinfblue1}{RGB}{0,134,134}% dark blue
\definecolor{sisinfblue2}{RGB}{113,109,143} % light blue
\definecolor{sisinfblue3}{RGB}{194,193,204} % lighter blue
\definecolor{sisinfblue4}{RGB}{100,100,255}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Lists
...
\setlist{%
  ...
  font=\color{sisinfblue1}\normalfont, %set the colour of all bullets, numbers and descriptions to sisinfblue1
}
...
%\setdescription{font=\color{sisinfblue1}\normalfont\bfseries}
...
%\setlist[description]{font=\color{sisinfblue1}\normalfont\bfseries}
...
% Macros
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\alert}[1]{{\color{sisinfblue1}#1}}
...
\background{
  \begin{tikzpicture}[remember picture,overlay]%
    ...
    \fill[fill=sisinfblue3] (current page.north west) rectangle (current page.south east);
    %the header
    \fill [fill=sisinfblue1] (current page.north west) rectangle ([yshift=-\headerheight] current page.north east);
  \end{tikzpicture}
}
...
%  bgColortwo=green!42, %is used when background is shaded
  ...
  %posterbox options
  headerborder=closed,
  borderColor=sisinfblue1,
  headershape=rectangle,
  headershade=plain,
  headerColorOne=sisinfblue1,
...
%the Eye Catcher (the logo on the left)
{
  ...
  \includegraphics[height=0.90\headerheight]{images/poliba-logo}
}
%the poster title
{\color{sisinfblue1}\bf
  Taralli Poster Theme
}
%the author(s)
{\small
  \vspace{1em} Hasan Ali Khattak\\[0.5em]
  Dept.\ of Electronic Engineering, Politecnico di Bari, Italy.\\
  hasan.alikhattak@deemail.poliba.it
}
%the logo (the logo on the right)
{
  %this can be commented out or replaced by a company/department logo
  \includegraphics[height=0.75\headerheight]{images/sisinf-logo}
}
...
\begin{itemize}
  ...
  \item So far no official poster theme is available to the researchers and students at Politecnico di Bari (PoliBa).
...
\begin{itemize}
  \item To use this poster theme, place the {\tt taralliposter.tex} file in your preferred folder and modify the file to your needs.
...
\begin{posterbox}[name=feedback,column=2,below=problems]{Feedback}
  \begin{itemize}
    \item This poster theme has been tested with baposter v. 2.0, and it can be downloaded from my website \cite{khattak} or my personal website \cite{hasan}.
...
\bibitem{khattak} Hasan Ali Khattak: \emph{Official Beamer Theme, Poster Theme, and Report Template}, \url{http://sisinflab.poliba.it/latex/latex.php}
\bibitem{hasan} Hasan ali khattak: \emph{Hasan @ SisInfLab}, \url{http://sisinflab.poliba.it/hasan}
\end{thebibliography}
