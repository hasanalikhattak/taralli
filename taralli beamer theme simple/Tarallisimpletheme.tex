...
% colored hyperlinks
\newcommand{\chref}[2]{%
  \href{#1}{{\usebeamercolor[bg]{Tarallisimple}#2}}%
}
...
\institute[
  {\includegraphics[scale=0.4]{images/sisinflab}}\\ %insert a company, department or university logo
...
\begin{frame}{Installation}
  ...
  \begin{enumerate}
    \item {\tt beamerthemeTarallisimple.sty}
    \item {\tt beamerinnerthemeTarallisimple.sty}
    \item {\tt beamerouterthemeTarallisimple.sty}
    \item {\tt beamercolorthemeTarallisimple.sty}
  \end{enumerate}
...
\begin{frame}{User Interface}{Loading the Theme and Theme Options}
  \begin{block}{The Outer Theme}
    ...
    {\tt \textbackslash useoutertheme[<options>]\{Tarallisimple\}}\\
...
\begin{frame}{User Interface}{Loading the Theme and Theme Options}
  \begin{block}{The Color Theme}
    ...
    {\tt \textbackslash usecolortheme\{Tarallisimple\}}\\
    and it has no options.
  \end{block}
  \pause
  \begin{block}{The Color Element {\tt Tarallisimple}}
    The color theme defines a new beamer color element named {\tt Tarallisimple} whose foreground and background colors are
    \begin{itemize}
      \item fg: {\usebeamercolor[fg]{Tarallisimple}light blue (\{RGB\}\{194,193,204\})}
      \item bg: {\usebeamercolor[bg]{Tarallisimple}dark blue (\{RGB\}\{33,26,82\})}
    \end{itemize}
    You can use these colors in the standard beamer way by using the command
    {\tt \textbackslash usebeamercolor[<fg or bg>]\{Tarallisimple\}}. See the beamer manual for instructions.\\
 \pause Note that this version of the theme follows official Poliba Colors. However, you can easily change it (including the logo) by following the steps in  {\tt beamercolorthemeTarallisimple.sty}.
  \end{block}
\end{frame}
%%%%%%%%%%%%%%%%
...
{\setbeamercolor{Tarallisimple}{fg=gray!50,bg=orange!50}
  ...
  \begin{itemize}
    ...
    \item<3-> For example, on this slide the following commands have been used
      \begin{itemize}
        ...
        {\tt \textbackslash setbeamercolor\{Tarallisimple\}\{fg=blue!20,bg=red!50\}}
